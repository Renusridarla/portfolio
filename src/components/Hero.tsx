      ...
      <div className="max-w-5xl mx-auto text-center relative z-10 space-y-6">
        ...
        >
          <div className="relative group cursor-pointer">
            <div className="absolute -inset-1 rounded-full bg-gradient-to-r from-purple-600 via-violet-500 to-indigo-600 opacity-75 blur-md group-hover:opacity-100 transition duration-500 group-hover:scale-105" />
            <div className="relative w-28 h-28 sm:w-36 sm:h-36 rounded-full overflow-hidden border-2 border-purple-400/60 shadow-[0_0_30px_rgba(168,85,247,0.35)] bg-[#090317]">
              <img
                src="/profile.jpg"
                alt="Darla Renusri"
