...
Personal portfolio website for **DARLA RENUSRI**, Computer Science Undergraduate & Aspiring Software Engineer. Built with a modern dark purple & black theme, interactive ambient canvas, selective glassmorphism, responsive navigation, and project live launch links.
...
- **Icons & Effects**: Lucide React, HTML5 Canvas Ambient Lighting, Canvas-Confetti
- **Deployment**: Vercel
